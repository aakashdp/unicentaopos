...
// end     
    ...
    private Double m_dSalesDeposits;
...
// JG 9 Nov 12
        ...
        Object[] valcategorysales = (Object []) new StaticSentence(app.getSession()
            , "SELECT COUNT(*), SUM(TICKETLINES.UNITS), SUM((TICKETLINES.PRICE + TICKETLINES.PRICE * TAXES.RATE + TICKETLINES.DEPOSIT ) * TICKETLINES.UNITS) " +
        ...
        List categorys = new StaticSentence(app.getSession()
            , "SELECT a.NAME, sum(c.UNITS), sum(c.UNITS * (c.PRICE + (c.PRICE * d.RATE) + c.DEPOSIT)) " +
...
// JG 16 Oct 13 - Added. Shaun Cains ADD REASON
        ...
        Object[] recsales = (Object []) new StaticSentence(app.getSession(),
                "SELECT COUNT(DISTINCT RECEIPTS.ID), SUM(TICKETLINES.UNITS * TICKETLINES.PRICE), SUM(TICKETLINES.UNITS * TICKETLINES.DEPOSIT) " +
        ...
        if (recsales == null) {
            ...
            p.m_dSalesDeposits = (Double) recsales[2];
        }             
...
// JG 16 May 2013 use diamond inference
        ...
        List products = new StaticSentence(app.getSession()
            , "SELECT PRODUCTS.NAME, SUM(TICKETLINES.UNITS), TICKETLINES.PRICE, TAXES.RATE, TICKETLINES.DEPOSIT " +
              ...
              "GROUP BY PRODUCTS.NAME, TICKETLINES.PRICE, TAXES.RATE, TICKETLINES.DEPOSIT"
            , SerializerWriteString.INSTANCE
...
//        return m_sHost;
     ...
     * @return
     */
    public String printSalesDeposits() {
        return Formats.CURRENCY.formatValue(m_dSalesDeposits);
    }
    ...
    public String printSalesTotal() {            
        return Formats.CURRENCY.formatValue((m_dSalesBase == null || m_dSalesTaxes == null)
                ? null
                : m_dSalesBase + m_dSalesTaxes + m_dSalesDeposits);
    }     
...
// end
     ...
     */
        ...
        public void readValues(DataRead dr) throws BasicException {
            ...
            m_Deposit = dr.getDouble(5);
            m_ProductPriceTotal = m_ProductPrice + m_ProductPrice*m_TaxRate + m_Deposit;
         ...
         * @return
         */
        public String printProductPriceTotal() {
            return Formats.CURRENCY.formatValue(m_ProductPriceTotal);
        }      
        /**
         *
         * @return
        ...
        public String printProductSubValue() {
            return Formats.CURRENCY.formatValue(m_ProductPriceTotal*m_ProductUnits);
        }
