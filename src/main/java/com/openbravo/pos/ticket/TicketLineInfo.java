...
public class TicketLineInfo implements SerializableWrite, SerializableRead, Serializable {
     ...
     * @param tax
     * @param props */
    public TicketLineInfo(String productid, double dMultiply, double dPrice, double dDeposit, TaxInfo tax, Properties props) {
        init(productid, null, dMultiply, dPrice, dDeposit, tax, props);
    }
     ...
     * @param tax
     */
    public TicketLineInfo(String productid, double dMultiply, double dPrice, double dDeposit, TaxInfo tax) {
        init(productid, null, dMultiply, dPrice, dDeposit, tax, new Properties());
    }
     ...
     * @param tax
     */
    public TicketLineInfo(String productid, String productname, String producttaxcategory, double dMultiply, double dPrice, double dDeposit, TaxInfo tax) {
     ...
     * @param tax
     */
    public TicketLineInfo(String productname, String producttaxcategory, double dMultiply, double dPrice, double dDeposit, TaxInfo tax) {

        Properties props = new Properties();
        props.setProperty("product.name", productname);
        props.setProperty("product.taxcategoryid", producttaxcategory);
        init(null, null, dMultiply, dPrice, dDeposit, tax, props);
    }
    ...
    public TicketLineInfo() {
        init(null, null, 0.0, 0.0, 0.0, null, new Properties());
    }
     ...
     * @param attributes
     */
    public TicketLineInfo(ProductInfoExt product, double dMultiply, double dPrice, double dDeposit, TaxInfo tax, Properties attributes) {
...
//        
        ...
        init(pid, null, dMultiply, dPrice, dDeposit, tax, attributes);
    }
     ...
     * @param attributes
     */
    public TicketLineInfo(ProductInfoExt oProduct, double dPrice, double dDeposit, TaxInfo tax, Properties attributes) {
        this(oProduct, 1.0, dPrice, dDeposit, tax, attributes);
    }
    ...
    public TicketLineInfo(TicketLineInfo line) {
        init(line.productid, line.attsetinstid, line.multiply, line.price, line.deposit, line.tax, (Properties) line.attributes.clone());
    }

    private void init(String productid, String attsetinstid, double dMultiply, double dPrice, double dDeposit, TaxInfo tax, Properties attributes) {
...
//System.out.println(value);            
     ...
     * @param dValue
     */
    public void setDepositRate(double dValue) {
        deposit = dValue;
    }    
    ...
    public double getValue() {
        return ( price * multiply * (1.0 + getTaxRate())) + getDeposit();
    }
    ...
    public String printDeposit() {
        return Formats.CURRENCY.formatValue(getDeposit());
    }    
